...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th10 11, 2021 lúc 12:36 PM
...
(1, 'Bằng nấu ăn', 'phôi-bằng-đại-học.jpg', 1),
...
(1, 'Công Ty ABC', 'Song song với việc đào tạo theo chương trình chung, trung tâm luôn tích cực hỗ trợ tìm việc cho các bạn học viên.Song song với việc đào tạo theo chương trình chung, trung tâm luôn tích cực hỗ trợ tìm việc cho các bạn học viên.Song song với việc đào tạo theo chương trình chung.', 'Ô Môn, Bình Thủy, Cần Thơ', 'Đâu bếp trưởng', '31.jpg', 9),
(2, 'Nhà Hàng', 'Song song với việc đào tạo theo chương trình chung, trung tâm luôn tích cực hỗ trợ tìm việc cho các bạn học viên.Song song với việc đào tạo theo chương trình chung, trung tâm luôn tích cực hỗ trợ tìm việc cho các bạn học viên.Song song với việc đào tạo theo chương trình chung.', 'Xuân Khánh, Ninh Kiều, Cần Thơ', 'Phục vụ', '10-luu-y-khi-khoi-nghiep-kinh-doanh-nha-hang-7460-1.jpg', 24);
...
(1, 'Trung tâm đào tạo ngành nghề (cơ sở 1)', '0365476962', 'Đương 3/2, Q.Ninh kiều', 3),
(2, 'Trung tâm đào tạo ngành nghề  (cơ sở 2)', '0365476962', 'Số 16/C, đường Mạc Thiên Tích', 2),
(3, 'Trung tâm đào tạo ngành nghề  (cơ sở 3)', '0365476962', 'Số 16/C, đường Mạc Thiên Tích', 2);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `cutrugv`
--
...
--
-- Cấu trúc bảng cho bảng `cutruhv`
--
...
--
-- Đang đổ dữ liệu cho bảng `cutruhv`
--
...
(88, 'Cần Thơ', 'YES', 65, 1),
(103, 'Số 225,', 'NO', 75, 1),
(104, 'Cần Thơ', 'YES', 75, 1);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `danhsachchungchi`
--
...
--
-- Đang đổ dữ liệu cho bảng `danhsachchungchi`
--
...
(1, '00001/2019', 'Sơ cấp', 'Khá', '2019-02-01', '2021-10-07', 'Route.jpg', 'K1', 'L01', 'THVP', 1),
(2, '00002/2019', 'Trung cấp', 'Khá', '2019-05-30', '2019-07-30', 'View.jpg', 'K1', 'L02', 'TK', 2),
(5, '001/2021', 'Khá', 'Khá', '2021-09-01', '2021-10-08', 'NO FILE', 'K3', 'L08', 'PCTS', 5),
(11, '0006/2021', 'Trung cấp', 'Trung bình', '2021-10-07', '2021-10-07', 'NO FILE', 'K1', 'L01', 'THVP', 63);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `day_nghe`
--
...
--
-- Đang đổ dữ liệu cho bảng `day_nghe`
--
...
--
-- Cấu trúc bảng cho bảng `day_o_lop`
--
...
--
-- Đang đổ dữ liệu cho bảng `day_o_lop`
--
...
(3, '899879660', 'Nguyễn Thị Cao', '9302263968_690841895-601x900.jpg', 'Nam', '1990-01-01', '0987544322', 'Tiến sĩ', 'lưu đường dẫn hoặc tên file Ex: public\\File\\lylichgiaovien\\lylich1.docx'),
...
CREATE TABLE `hocvien` (
  ...
  `HV_HINHANH` varchar(200) DEFAULT NULL,
...
(1, '366159861', 'Đinh Lê Anh Quang', '', '0337254039', '1999-08-06', 'Nữ', 'YES', 'Kinh', '12/12', 'Chưa có', 0, '<p>Đi nghĩa vụ quân sự</p><p><br></p>', 0, 1),
(2, '366159860', 'Phan Thanh Phú', '', '0337474508', '1999-01-01', 'Nam', 'YES', 'Kinh', '12/12', 'Chưa có', 0, NULL, 0, 1),
(4, '366258489', 'Trần Văn Độ', '', '0974563487', '1998-04-12', 'Nam', 'NO', 'Khơ me', '12/12', 'Cty Tân Lộc, tp. Hồ Chí Minh', 0, NULL, 0, 2),
(5, '345678900', 'Ngô Vũ Bão', '', '0832474567', '1998-12-06', 'Nam', 'YES', 'Hoa', 'Cao đẳng', 'CTU Cần Thơ', 0, NULL, 0, 2),
(63, '366186204', 'Trần Hải Thịnh', 'tinngan_111904_385349643_0.jpg', '03124652874', '2004-03-16', 'Nam', 'YES', 'Khơ me', '4/12', 'Cần thơ', 0, 'Tạm hoãn', 36, 1),
...
(75, '123456223', 'Quang', 'work-6.png', '0337254039', '2000-02-09', 'Nam', 'YES', 'Kinh', '8/12', 'Cần thơ', 0, NULL, 41, 3);
...
--
-- Cấu trúc bảng cho bảng `hoc_tai_lop`
--
...
--
-- Đang đổ dữ liệu cho bảng `hoc_tai_lop`
--
...
--
-- Cấu trúc bảng cho bảng `loaichuongtrinh`
--
...
--
-- Đang đổ dữ liệu cho bảng `loaichuongtrinh`
--
...
--
-- Cấu trúc bảng cho bảng `loaihinhdaotao`
--
...
--
-- Đang đổ dữ liệu cho bảng `loaihinhdaotao`
--
...
--
-- Cấu trúc bảng cho bảng `loainganhdaotao`
--
...
--
-- Đang đổ dữ liệu cho bảng `loainganhdaotao`
--
...
--
-- Cấu trúc bảng cho bảng `nganhnghedaotao`
--
...
--
-- Đang đổ dữ liệu cho bảng `nganhnghedaotao`
--
...
--
-- Cấu trúc bảng cho bảng `nguoiquen`
--
...
--
-- Đang đổ dữ liệu cho bảng `nguoiquen`
--
...
(44, 'Phan Văn A2', '09393466', 'Cần Thơ1', 65),
(52, 'Phan Văn A', '093934668', 'cà mau', 75);
...
--
-- Cấu trúc bảng cho bảng `sap_lich`
--
...
--
-- Đang đổ dữ liệu cho bảng `sap_lich`
--
...
(48, 'Sáng', '2021-09-06', 1, 64),
(49, 'Chiều', '2021-08-04', 1, 65),
(52, 'Chiều', '2021-09-03', 1, 68),
(53, 'Sáng', '2021-09-13', 1, 69),
...
(7, 'phu', 'phu@gmail.com', '0365476962', '9h00 - 11h00', 0, 11, 1);
...
(1, 'admin', 'admin', 'admin@gmail.com', '0365476962', NULL, '$2y$10$K9xLH3B0x8VTPinENYsGDuxNrEwJyuog3W4oh2jzndtrIyS.X7vKO', 1, NULL),
(13, '', 'Đặng Thị Phương Thảo', 'thao1234@gmail.com', '0123456789', 'ttt.jpg', '$2y$10$m4jVflSVo1UVrsc1dt0BCufN2hRlQojU4g2K79xAy9KlMOCCf5VIS', 2, NULL),
(16, '', 'Phan Thanh Phu', 'phu@gmail.com', '0365476962', 'banh_kem.png', '$2y$10$t68WW0IYLy7kHT0IXfmwWeEO1Xtiuzu0ez7794a2FOM7q7FwWeHVy', 2, NULL),
(17, '', 'USER12', 'user11@gmail.com', '0365476962', 'user.jpg', '$2y$10$KjtJd1cBj5nJpRQRO5ssQOvgawKIts8ePQDBTmsjxi7KgKH.t7pXS', NULL, NULL),
(20, '', 'Thanh Phu7', 'phu@123.com', '0365476962', '068846a63888cfd69699.jpg', '$2y$10$meBoL3K04VpL78XXfadQ1uOBZpQBWKNO4CokiVMQc2UzBVsm7oCD2', NULL, NULL),
...
(25, 'Nguyễn Văn A', 'Nguyễn Văn A', 'nguyenvana@gmail.com', '0215364796', NULL, '$2y$10$IGSMf9TohV3fLcFbVXQz7OgiKV4Sez21cUISXQwsS.6C99l1MRZfq', 2, 1),
(26, '', 'Quang', 'quang@gmail.com', '0365476962', 'chậu.jpg', '$2y$10$.lnkjDO/IppwwDjzCMJgAeJwlW.qEa0JgUScJwgTnYYm4Y9Xxkn1K', NULL, NULL),
(27, '', 'bi', 'bi@gmail.com', '0365476962', 'chậu.jpg', '$2y$10$qIz4ihN6Xt0.TcloLqu0F.k5hEQQY5ckDCIgNksWwvK3TtHykm4G6', 2, NULL),
...
(41, '', 'Quang', 'quang1234@gmail.com', '025463687', '88.jpg', '$2y$10$bwwXin5T7/YBJ.4jx7ae1ekz3BjwIiGl/Fnwk5I2N.juyl57LItFC', NULL, NULL),
(42, '', 'Thảo', 'thao@gmail.com', '0258963214', 'work-6.png', '$2y$10$SMi5X0AyBFX/IUupLmpY0eQRSDgs9IkNW5Z5OZt/3XmVOX4asJKti', NULL, NULL),
(43, '', 'Thanh Thành', 'thanhtran@gmail.com', '0365485263', 'tinngan_111904_385349643_0.jpg', '$2y$10$pd2nvvkZrXNW7hjfPbJgtuC6nNSGEU.emlLHP00gHl4VUvHZeuewG', NULL, NULL),
(44, '', 'thanhngan', 'thanhngan@gmail.com', '012245699', '068846a63888cfd69699.jpg', '$2y$10$jy.NXW2k359xRs.fpLZRcucTwAoC4yGOcvF8OfO14Xj8EMPUjznj.', NULL, NULL),
(48, '', 'tin', 'tin@gmail.com', '0365476962', '068846a63888cfd69699.jpg', '$2y$10$8Qch1Mw7nDz.MXiY6MToOupQ.CrP1x8jKFgq26lxE6xQZJb.SzFV2', NULL, NULL),
(49, '', 'Thanh phú67', 'thanhphu@gmail.com', '0365485268', NULL, '$2y$10$C/2x2nhSiAyDjXPN1J5uOeHcfcwd/RjQN0xH29gBN8dqYvWjTrZ0m', NULL, 2);

-- --------------------------------------------------------

--
-- Cấu trúc bảng cho bảng `vanbanhanhchanh`
--
...
--
-- Chỉ mục cho bảng `danhsachchungchi`
--
...
--
-- Chỉ mục cho bảng `loaichuongtrinh`
--
...
--
-- Chỉ mục cho bảng `loaihinhdaotao`
--
ALTER TABLE `loaihinhdaotao`
  ADD PRIMARY KEY (`id`);

--
-- Chỉ mục cho bảng `loainganhdaotao`
--
...
--
-- Chỉ mục cho bảng `nganhnghedaotao`
--
...
--
-- Chỉ mục cho bảng `vanbanhanhchanh`
--
...
--
-- AUTO_INCREMENT cho bảng `cutrugv`
--
ALTER TABLE `cutrugv`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23;

--
-- AUTO_INCREMENT cho bảng `cutruhv`
--
ALTER TABLE `cutruhv`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=133;

--
-- AUTO_INCREMENT cho bảng `danhsachchungchi`
--
ALTER TABLE `danhsachchungchi`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT cho bảng `day_nghe`
--
ALTER TABLE `day_nghe`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=33;

--
-- AUTO_INCREMENT cho bảng `day_o_lop`
--
ALTER TABLE `day_o_lop`
...
--
-- AUTO_INCREMENT cho bảng `hoc_tai_lop`
--
ALTER TABLE `hoc_tai_lop`
...
--
-- AUTO_INCREMENT cho bảng `loaichuongtrinh`
--
ALTER TABLE `loaichuongtrinh`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
-- AUTO_INCREMENT cho bảng `loaihinhdaotao`
--
ALTER TABLE `loaihinhdaotao`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT cho bảng `loainganhdaotao`
--
ALTER TABLE `loainganhdaotao`
...
--
-- AUTO_INCREMENT cho bảng `nganhnghedaotao`
--
ALTER TABLE `nganhnghedaotao`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=34;

--
-- AUTO_INCREMENT cho bảng `nguoiquen`
--
ALTER TABLE `nguoiquen`
...
--
-- AUTO_INCREMENT cho bảng `sap_lich`
--
ALTER TABLE `sap_lich`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=17;

--
-- AUTO_INCREMENT cho bảng `thicu`
--
ALTER TABLE `thicu`
  MODIFY `id` bigint(20) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;
...
--
-- AUTO_INCREMENT cho bảng `vanbanhanhchanh`
--
ALTER TABLE `vanbanhanhchanh`
...
--
-- Các ràng buộc cho bảng `cutrugv`
--
ALTER TABLE `cutrugv`
...
--
-- Các ràng buộc cho bảng `cutruhv`
--
ALTER TABLE `cutruhv`
...
--
-- Các ràng buộc cho bảng `day_o_lop`
--
ALTER TABLE `day_o_lop`
...
--
-- Các ràng buộc cho bảng `hoc_tai_lop`
--
ALTER TABLE `hoc_tai_lop`
...
--
-- Các ràng buộc cho bảng `nganhnghedaotao`
--
ALTER TABLE `nganhnghedaotao`
...
--
-- Các ràng buộc cho bảng `nguoiquen`
--
ALTER TABLE `nguoiquen`
...
--
-- Các ràng buộc cho bảng `sap_lich`
--
ALTER TABLE `sap_lich`
...
--
-- Các ràng buộc cho bảng `vanbanhanhchanh`
--
ALTER TABLE `vanbanhanhchanh`
